...
<p align="center">
  <a href="https://github.com/your-org/OpenSpec/releases/latest"><img src="https://img.shields.io/github/v/release/your-org/OpenSpec" alt="Latest release"></a>
  <a href="https://github.com/your-org/OpenSpec"><img src="https://img.shields.io/github/stars/your-org/OpenSpec?color=%23F4A460" alt="GitHub Stars"></a>
  <a href="https://github.com/your-org/OpenSpec"><img src="https://img.shields.io/github/forks/your-org/OpenSpec?color=%2388CCFF" alt="GitHub Forks"></a>
</p>
...
<p align="center">
  <a href="https://www.youtube.com/watch?v=YOUR_VIDEO_ID">
    <img src="docs/images/video_cover.png" alt="OpenSpec 产品演示" width="700" />
  </a>
</p>
-->
...
<table style="border-collapse: collapse; border: 1px solid black;">
  <tr>
    <td style="padding: 5px;background-color:#fff;"><img src="docs/prototypes/project_info_page.jpg" alt="项目信息页" /></td>
    <td style="padding: 5px;background-color:#fff;"><img src="docs/prototypes/document_create_page.jpg" alt="文档创建页" /></td>
  </tr>
  <tr>
    <td style="padding: 5px;background-color:#fff;">
      <!-- <img src="docs/images/editor.png" alt="文档编辑器" /> -->
      编辑器截图待补充
    </td>
    <td style="padding: 5px;background-color:#fff;">
      <!-- <img src="docs/images/chat_assistant.png" alt="AI 对话助手" /> -->
      AI 助手截图待补充
    </td>
  </tr>
</table>
...
- [API 接口文档](docs/api/API_接口文档.md)
- [后端 API 说明](docs/api/backend_api.md)
- [会话记忆控制](docs/api/session_memory_control.md)
- [模板智能匹配设计](docs/design/模板智能匹配功能设计方案.md)
